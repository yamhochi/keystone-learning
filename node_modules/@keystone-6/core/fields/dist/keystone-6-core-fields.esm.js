...
import { u as userInputError, h as humanize } from '../../dist/graphql-errors-68845105.esm.js';
import { f as fieldType, o as orderDirectionEnum } from '../../dist/mysql-a7009855.esm.js';
import { f as filters, r as resolveCommon, j as jsonFieldTypePolyfilledForSQLite, a as resolveString } from '../../dist/json-field-type-polyfill-for-sqlite-3fe843bc.esm.js';
import { a as Decimal, U as Upload, J as JSON$1, D as DateTime } from '../../dist/graphql-ts-schema-ecd3b4c2.esm.js';
import '@graphql-tools/schema';
import path__default from 'path';
import { p as packagePath } from '../../dist/package-path-5ec371a3.esm.js';
import { arg, nonNull, Boolean, inputObject, String, Int, Float, enum as enum$1, enumValues, ID, list } from '@graphql-ts/schema/api-without-context';
  ...
  return meta => {
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(Boolean) : Boolean,
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(Boolean) : Boolean
      }),
  ...
  return meta => {
    ...
    return fieldType(dbField)(_objectSpread(_objectSpread({}, config), {}, {
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(Decimal) : Decimal,
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(Decimal) : Decimal,
    ...
    hooks: storage.preserve ? config.hooks : _objectSpread(_objectSpread({}, config.hooks), {}, {
      async beforeOperation(args) {
        ...
        if (args.operation === 'update' || args.operation === 'delete') {
          ...
          const filename = args.item[filenameKey]; // This will occur on an update where a file already existed but has been
  ...
  return meta => {
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(Float) : Float,
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(Float) : Float
      }),
  ...
  return meta => {
    ...
    if (hasAutoIncDefault) {
      ...
      if (meta.provider === 'mysql' && !isIndexed) {
        throw new Error(`The integer field at ${meta.listKey}.${meta.fieldKey} specifies defaultValue: { kind: 'autoincrement' }, but doesn't specify isIndexed: true or 'unique'. autoincrement fields on MySQL must have an index.`);
      }
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(Int) : Int,
            defaultValue: (_config$graphql2 = config.graphql) !== null && _config$graphql2 !== void 0 && (_config$graphql2$crea = _config$graphql2.create) !== null && _config$graphql2$crea !== void 0 && _config$graphql2$crea.isNonNull && typeof defaultValue === 'number' ? defaultValue : undefined
          }),
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(Int) : Int
      }),
    ...
    hooks: storage.preserve ? config.hooks : _objectSpread(_objectSpread({}, config.hooks), {}, {
      async beforeOperation(args) {
        ...
        if (args.operation === 'update' || args.operation === 'delete') {
          ...
          const extension = args.item[extensionKey]; // This will occur on an update where an image already existed but has been
          // changed, or on a delete, where there is no longer an item
...
const json = function () {
  ...
  return meta => {
    ...
    const resolve = val => val === null && (meta.provider === 'postgresql' || meta.provider === 'mysql') ? 'DbNull' : val;
  ...
  return meta => {
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(String) : String,
            defaultValue: (_config$graphql2 = config.graphql) !== null && _config$graphql2 !== void 0 && (_config$graphql2$crea = _config$graphql2.create) !== null && _config$graphql2$crea !== void 0 && _config$graphql2$crea.isNonNull ? defaultValue : undefined
          }),
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(String) : String
      }),
...
const timestamp = function () {
  ...
  return meta => {
    ...
    if (typeof defaultValue === 'string') {
      try {
        DateTime.graphQLType.parseValue(defaultValue);
      } catch (err) {
    ...
    const parsedDefaultValue = typeof defaultValue === 'string' ? DateTime.graphQLType.parseValue(defaultValue) : defaultValue;
    const resolvedIsNullable = getResolvedIsNullable(validation, config.db);
    assertReadIsNonNullAllowed(meta, config, resolvedIsNullable);
    assertCreateIsNonNullAllowed(meta, config);
    const mode = resolvedIsNullable === false ? 'required' : 'optional';
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: arg({
            type: (_config$graphql = config.graphql) !== null && _config$graphql !== void 0 && (_config$graphql$creat = _config$graphql.create) !== null && _config$graphql$creat !== void 0 && _config$graphql$creat.isNonNull ? nonNull(DateTime) : DateTime,
      ...
      output: field({
        type: (_config$graphql3 = config.graphql) !== null && _config$graphql3 !== void 0 && (_config$graphql3$read = _config$graphql3.read) !== null && _config$graphql3$read !== void 0 && _config$graphql3$read.isNonNull ? nonNull(DateTime) : DateTime
      }),
...
export { checkbox, decimal, file, float, image, integer, json, password, relationship, select, text, timestamp, virtual };
