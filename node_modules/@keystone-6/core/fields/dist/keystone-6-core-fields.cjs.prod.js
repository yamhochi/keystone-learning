...
var graphqlErrors = require('../../dist/graphql-errors-60425d62.cjs.prod.js');
var mysql = require('../../dist/mysql-65db1e9f.cjs.prod.js');
var jsonFieldTypePolyfillForSqlite = require('../../dist/json-field-type-polyfill-for-sqlite-71779988.cjs.prod.js');
var graphqlTsSchema = require('../../dist/graphql-ts-schema-dc90e05f.cjs.prod.js');
require('@graphql-tools/schema');
var path = require('path');
var packagePath = require('../../dist/package-path-778df3f1.cjs.prod.js');
...
const decimal = function () {
  ...
  return meta => {
    ...
    return mysql.fieldType(dbField)(_objectSpread(_objectSpread({}, config), {}, {
...
const select = _ref => {
  ...
  return meta => {
    ...
    if (config.type === 'integer') {
      ...
      return mysql.fieldType(_objectSpread({
        kind: 'scalar',
        scalar: 'Int'
    ...
    if (config.type === 'enum') {
      ...
      return mysql.fieldType(meta.provider === 'sqlite' ? _objectSpread({
        kind: 'scalar',
        scalar: 'String'
