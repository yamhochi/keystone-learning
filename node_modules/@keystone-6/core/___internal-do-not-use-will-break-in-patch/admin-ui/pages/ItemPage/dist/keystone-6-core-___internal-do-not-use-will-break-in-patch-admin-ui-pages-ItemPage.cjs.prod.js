...
var Fields = require('../../../../../dist/Fields-3a640754.cjs.prod.js');
require('../../../../../dist/getRootGraphQLFieldsFromFieldController-22d5f934.cjs.prod.js');
var useInvalidFields = require('../../../../../dist/useInvalidFields-c94c0172.cjs.prod.js');
...
var PageContainer = require('../../../../../dist/PageContainer-6336f78d.cjs.prod.js');
var GraphQLErrorNotice = require('../../../../../dist/GraphQLErrorNotice-b47e5e7c.cjs.prod.js');
var common = require('../../../../../dist/common-a5898b89.cjs.prod.js');
...
const ItemPage = _ref4 => {
  ...
  const {
    ...
    let selectedFields = Object.entries(list.fields).filter(_ref5 => {
      let [fieldKey, field] = _ref5;
      return field.itemView.fieldMode !== 'hidden' || // the id field is hidden but we still need to fetch it
      fieldKey === 'id';
    }).map(_ref6 => {
      let [fieldKey] = _ref6;
  ...
  const pageTitle = loading$1 ? undefined : data && data.item && (data.item[list.labelField] || data.item.id) || id;
