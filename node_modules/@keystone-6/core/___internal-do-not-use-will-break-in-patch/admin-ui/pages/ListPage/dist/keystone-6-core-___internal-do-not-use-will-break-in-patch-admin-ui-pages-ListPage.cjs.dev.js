...
var getRootGraphQLFieldsFromFieldController = require('../../../../../dist/getRootGraphQLFieldsFromFieldController-22da37b9.cjs.dev.js');
require('fast-deep-equal');
var client = require('@apollo/client');
var _objectWithoutProperties = require('@babel/runtime/helpers/objectWithoutProperties');
var CellLink = require('../../../../../dist/CellLink-ab637f00.cjs.dev.js');
...
const ListPage = _ref => {
  ...
  'Error...' : data && metaQuery.data ? core.jsx(React.Fragment, null, list.description !== null && core.jsx("p", {
    ...
    list: list
  }) : null, Boolean(filters.filters.length || query.sortBy || query.fields) && core.jsx(button.Button, {
    size: "small",
...
const ResultsSummaryContainer = _ref4 => {
  let {
    children
  } = _ref4;
  return core.jsx("p", {
...
const SortDirectionArrow = _ref5 => {
  let {
    direction
  } = _ref5;
  const size = '0.25em';
...
function DeleteManyButton(_ref6) {
  let {
    selectedItems,
    list,
    refetch
